...
<head>
    ...
    <link rel="stylesheet" href="../util/bootstrap/bootstrap.css">
    <!-- Fontawesome CSS -->
    <!-- <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.1/css/all.css"
        integrity="sha384-vp86vTRFVJgpjF9jiIGPEEqYqlDwgyBgEF109VFjmqGmIY/Y4HV4d3Gp2irVfcrp" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="../util/fontawesome/css/all.css">
    <!-- Google Font CSS -->
    <!-- <link href="https://fonts.googleapis.com/css2?family=Poppins&display=swap" rel="stylesheet"> -->
    <link rel="stylesheet" href="../util/googleFont/googleFont.css">
...
<body>
    ...
    <script src="../util/bootstrap/bootstrap.js"></script>
